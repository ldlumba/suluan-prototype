...
| Knowledge Graph Page | Implemented | Aligned. Static metadata graph supports paper, author, department, theme, keyword, and related-paper relationships. | Chapter 1 Objective 3; Chapter 2 conceptual framework |
