  ...
  if (!record) {
    return (
      <div>
        ...
        <div className="mt-6"><Link to="/browse" className="text-sm font-semibold text-[#0038A8] hover:text-[#002D72]">Back to validated records</Link></div>
      </div>
    )
  }
    ...
    <div>
      ...
      <section className="mt-5 grid gap-5 lg:grid-cols-[1fr_320px]">
        <article className="rounded-xl border border-stone-200 bg-white p-6 shadow-sm">
          ...
          <button type="button" onClick={handleCopy} className="mt-3 inline-flex items-center gap-2 rounded-lg bg-[#0038A8] px-3 py-2 text-sm font-semibold text-white hover:bg-[#002D72]">
      ...
      <div className="mt-6"><Link to="/browse" className="text-sm font-semibold text-[#0038A8] hover:text-[#002D72]">Back to browse</Link></div>
    </div>
  )
}
