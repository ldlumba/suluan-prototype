...
const colors = ['#0038A8', '#1E63B5', '#002D72', '#FFD100', '#CE1126', '#5b6472']
  ...
  return (
    <div>
      ...
      <section className="mt-5 grid gap-5 xl:grid-cols-2">
        <ChartFrame title="Validated papers by academic unit"><ResponsiveContainer><BarChart data={byDepartment} layout="vertical" margin={{ left: 24, right: 16 }}><CartesianGrid strokeDasharray="3 3" /><XAxis type="number" allowDecimals={false} /><YAxis type="category" dataKey="name" width={170} tick={{ fontSize: 11 }} /><Tooltip /><Bar dataKey="value" fill="#0038A8" radius={[0, 4, 4, 0]} /></BarChart></ResponsiveContainer></ChartFrame>
        <ChartFrame title="Validated papers by year"><ResponsiveContainer><LineChart data={byYear}><CartesianGrid strokeDasharray="3 3" /><XAxis dataKey="name" /><YAxis allowDecimals={false} /><Tooltip /><Line type="monotone" dataKey="value" stroke="#1E63B5" strokeWidth={3} dot={{ r: 4 }} /></LineChart></ResponsiveContainer></ChartFrame>
